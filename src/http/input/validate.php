...
class validate
{
    ...
    public static function float_key(
        array $container,
        string $key
    ): float {
    ...
    public static function int_key(
        array $container,
        string $key
    ): int {
    ...
    public static function float_request(
        string $subject,
        array $default_return = []
    ): float {
    ...
    public static function int_request(
        string $subject,
        array $default_return = []
    ): int {
    ...
    public static function id_request(
        string $subject,
        array $default_return = []
    ): int {
    ...
    public static function string_request(
        string $subject,
        array $default_return = []
    ): string {
    ...
    private static function key_exists(
        array $container,
        string $key
    ): bool {
